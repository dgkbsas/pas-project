<script lang="ts">
  ...
  type ClientOption = Pick<Client, 'id' | 'first_name' | 'last_name'>;
  ...
  // Check for client_id in URL query params and load insurers
  onMount(async () => {
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          <label for="policy_number"
            >Número de Póliza <span class="required">*</span></label
          >
          <Input
            id="policy_number"
        ...
        <div class="form-group">
          <label for="policy_type"
            >Tipo de Seguro <span class="required">*</span></label
          >
          <Select
            id="policy_type"
