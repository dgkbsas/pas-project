...
declare module "$app/types" {
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/api/policies/update-expired": Record<string, never>;
			"/api/policies/[id]": { id: string };
			"/api/policies/[id]/followups": { id: string };
