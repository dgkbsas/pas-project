...
type LayoutRouteId = RouteId | "/(app)/clientes" | "/(app)/clientes/[id]" | "/(app)/clientes/[id]/editar" | "/(app)/clientes/nuevo" | "/(app)/configuracion" | "/(app)/dashboard" | "/(app)/polizas" | "/(app)/polizas/[id]/editar" | "/(app)/polizas/nuevo"
