...
type LayoutRouteId = RouteId | "/(app)/actividades" | "/(app)/clientes" | "/(app)/clientes/[id]" | "/(app)/clientes/[id]/editar" | "/(app)/clientes/nuevo" | "/(app)/configuracion" | "/(app)/dashboard" | "/(app)/polizas" | "/(app)/polizas/nuevo"
