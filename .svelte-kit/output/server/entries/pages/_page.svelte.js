...
function Spinner($$renderer, $$props) {
  ...
  $$renderer.push(`<div${attr_class(`spinner spinner-${stringify(size)} ${stringify(className)}`, "svelte-7uvg3c")} role="status"><span class="sr-only svelte-7uvg3c">Cargando...</span></div>`);
}
