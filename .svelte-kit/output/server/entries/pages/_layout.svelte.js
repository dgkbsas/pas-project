import { V as attr_class, W as attr, X as clsx, Y as ensure_array_like, Z as attr_style, _ as spread_props, $ as attributes, a0 as stringify, a1 as store_get, a2 as unsubscribe_stores } from "../../chunks/index2.js";
...
const PUBLIC_SUPABASE_URL = "https://cnwaaqvgwndsovmbchxp.supabase.co";
const PUBLIC_SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNud2FhcXZnd25kc292bWJjaHhwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjAxNzg5MzIsImV4cCI6MjA3NTc1NDkzMn0.c68M6iloQdPKTg3QkofAREIn5n1wQ7kAg-Wnh1T_JlE";
createBrowserClient(
  PUBLIC_SUPABASE_URL,
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    Toaster($$renderer2, {
      ...
      closeButton: true,
      richColors: true,
      theme: store_get($$store_subs ??= {}, "$theme", theme) === "dark" ? "dark" : "light"
    });
    $$renderer2.push(`<!---->`);
