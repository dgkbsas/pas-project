...
--   - Función helper en esquema public (sin permisos auth)
-- =====================================================
...
-- Crear función helper en el esquema PUBLIC (no requiere permisos especiales)
...
-- ✅ Función public.get_user_company_id() creada (no requiere permisos en auth)
...
-- - Función en esquema PUBLIC en lugar de auth (evita error de permisos)
-- - Todas las políticas usan public.get_user_company_id()
